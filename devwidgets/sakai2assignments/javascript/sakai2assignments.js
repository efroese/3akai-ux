...
require(["jquery", "sakai/sakai.api.core", "sakai/sakai.api.widgets"], function($, sakai, sakaiWidgetsAPI) {
     ...
     */
    sakai_global.sakai2assignments = function(tuid, showSettings){
        ...
        var saveRemoteContent = function(){
            ...
            json["lti_virtual_tool_id"] = "sakai.assignment.grades";
        ...
        var saveSettings = function(parameters, exists) {
            json = {
                ...
                lti_virtual_tool_id: "sakai.assignment.grades",
                isSakai2Tool: true
            };
            saveRemoteContent();
        };
    ...
    sakai.api.Widgets.widgetLoader.informOnLoad("sakai2assignments");
});
