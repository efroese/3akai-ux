...
require(["jquery", "sakai/sakai.api.core", "sakai/sakai.api.widgets"], function($, sakai, sakaiWidgetsAPI) {
     ...
     */
    sakai_global.sakai2samigo = function(tuid, showSettings){
        ...
        var saveRemoteContent = function(){
            ...
            json["lti_virtual_tool_id"] = "sakai.samigo";
        ...
        var saveSettings = function(parameters, exists){
            json = {
                ...
                lti_virtual_tool_id: "sakai.samigo",
                isSakai2Tool: true
            };
            saveRemoteContent();
        };
    ...
    sakai.api.Widgets.widgetLoader.informOnLoad("sakai2samigo");
});
